 ...
 * Use the [ModificacionReservaFragment.newInstance] factory method to
...
class ModificacionReservaFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ModificacionReservaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ModificacionReservaFragment()
                .apply {
