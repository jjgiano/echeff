...
class ViewModelPerfilChefConfiguracionFragment : ViewModel(), PerfilChefDao, HistoriaDao, UsuarioDao {
    ...
    fun agregarPerfil(perfilChef: PerfilChef) {
        viewModelScope.launch {
            add(perfilChef)
        }
    }
