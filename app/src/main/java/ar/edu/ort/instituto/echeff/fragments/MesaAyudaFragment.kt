...
class MesaAyudaFragment : Fragment() {
    ...
    override fun onStart() {
        ...
        buttonMesaAyuda.setOnClickListener {
            ...
            if (MesaAyudaFragmentArgs.fromBundle(super.requireArguments()).soyChef){
                v.findNavController().navigate(MesaAyudaFragmentDirections.actionMesaAyudaFragment2ToHomeChefFragment())
            } else {
                v.findNavController().navigate(MesaAyudaFragmentDirections.actionMesaAyudaFragment2ToHomeClienteFragment())
            }
        }
    }
}